...
addModeline () {
  ...
  # Return the name of the newly added modeline
  #echo "$1" | awk '{print "\"" $1 "\""}'
  echo "$1" | awk '{print $1}'
}
...
applyModeline () {
  ...
  #xrandr --output LVDS-1 --primary --mode 1366x768 --pos 1280x130 --rotate normal \
         #--output VGA-1 --primary --mode "$1" --pos 0x0 --rotate normal \
         #--output VGA-1 --primary --mode "1280x1024" --pos 0x0 --rotate normal \
...
#myModeline=$(generateModelineUsingCVT $thinkVisionW $thinkVisionH $thinkVisionF)
#echo $myModeline
#myModelineName=$(addModeline "$myModeline")
#echo $myModelineName
#applyModeline "$myModelineName"
applyModeline
#main
